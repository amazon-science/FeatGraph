...
from featgraph.util import util_partition_adj_coo_2d
...
def test_util_partition_adj_coo_2d():
    ...
    edge_id_list_after_partition, adj_row_indices_after_partition_np, adj_row_indices_after_partition_np = \
